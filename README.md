...
How to use it
-------
Download the file and extract it. Open terminal, change directory to extracted dir and run ./p-space.event or ./p-space.event& if you want it to run to backround.